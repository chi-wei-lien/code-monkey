...
- Best time complexity of Dijkstra implemented with a **Fibonacci heap**: <InlineCode>O(V \* log(V) + E)</InlineCode>
  - Too difficult to implement during an interview
- Space complexity of the given template: <InlineCode>O(E + V)</InlineCode>
